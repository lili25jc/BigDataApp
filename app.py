...
VERSION_APP = "Versión 3 - 05 de junio de 2025"
CREATOR_APP = "LilianaJC /https://github.com/lili25jc/BigDataApp"
mongo_uri   = os.environ.get("MONGO_URI")

if not mongo_uri:
    
    uri         = "mongodb+srv://LILIJC:DB2025@cluster0.qkojfmq.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
    mongo_uri   = uri
...
client = Elasticsearch(
    "https://bigdata-d0ae4a.es.us-east-1.aws.elastic.cloud:443",
    api_key="MXRMX1FaY0JOMUZYX3RVLW1Qb3o6U3A0cGJGNS1OT2RrUVlZN0ttVzhBQQ=="
)
INDEX_NAME = "ucentral-lilijc"
...
def login():
    if request.method == 'POST':
        ...
        client = connect_mongo()
        if not client:
            return render_template('login.html', error_message='Problema de conexión con la base de datos.', version=VERSION_APP,creador=CREATOR_APP)
...
def search():
    try:
        ...
        index_name = data.get('index', 'ucentral-lilijc')
